...
class BookingControllerTest {
    ...
    void create() {
        long userId = 1L;
        when(bookingService.add(anyLong(), any(BookingDto.class))).thenReturn(bookingDto);
    ...
    void approve() {
        ...
        when(bookingService.update(anyLong(), anyLong(), anyString())).thenReturn(bookingDto);
        ...
        verify(bookingService, times(1)).update(userId, bookingDto.getId(), status);
        verifyNoMoreInteractions(bookingService);
    }
