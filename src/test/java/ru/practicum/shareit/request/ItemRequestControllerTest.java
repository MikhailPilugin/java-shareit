...
class ItemRequestControllerTest {
    ...
    void returnUserRequests() {
        ...
        when(itemRequestService.returnUserRequests(anyLong())).thenReturn(List.of(itemRequestDto, secondDto));
        ...
        verify(itemRequestService, times(1)).returnUserRequests(userId);
        verifyNoMoreInteractions(itemRequestService);
    }
