...
class ItemServiceImplTest {
    ...
    void getById_whenUserIdNotOwner_thenReturnDtoWithoutBookings() {
        ...
        assertThat(returnedDto.getComments(), allOf(
                hasItem(commentMapper.toCommentDto(firstComment)),
                hasItem(commentMapper.toCommentDto(secondComment))));
    ...
    void getByQuery_whenQueryIsBlank_thenReturnEmptyList() {
        ...
        List<ItemDto> result = itemService.search(query, 0, 2);
    ...
    void getByQuery_whenQueryNotBlank_thenReturnItemListSizeEqualTwo() {
        ...
        assertThat(result, allOf(hasItem(itemMapper.toItemDto(firstItem)), hasItem(itemMapper.toItemDto(secondItem))));
